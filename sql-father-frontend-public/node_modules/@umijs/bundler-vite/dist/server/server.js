...
async function createServer(opts) {
  ...
  const viteConfigServer = __spreadValues({}, viteConfig.server);
  if (userConfig.https) {
  ...
  const vite = await (0, import_vite.createServer)(__spreadProps(__spreadValues(__spreadValues({}, viteConfig), typeof onDevCompileDone === "function" ? {
    ...
    server: __spreadProps(__spreadValues({}, viteConfigServer), { middlewareMode: "html" })
  }));
