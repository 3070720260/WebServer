    ...
    visitor: {
      Identifier(path, state) {
        ...
        if ((_a = state.opts.opts.identifierToLib) == null ? void 0 : _a.hasOwnProperty(name)) {
          ...
          replaceWith(path, name, libName, state.file, () => (0, import_helper_module_imports.addNamed)(path, name, libName));
          ...
          replaceWith(path, name, libName, state.file, () => (0, import_helper_module_imports.addDefault)(path, libName, {
            nameHint: name
          }));
          ...
          replaceWith(path, name, libName, state.file, () => (0, import_helper_module_imports.addNamespace)(path, libName));
        }
        if (name === "styles" && state.opts.css) {
          ...
          replaceWith(path, name, "./" + cssFilename, state.file, () => (0, import_helper_module_imports.addDefault)(path, "./" + cssFilename, { nameHint: name }));
        }
        if ((_d = state.opts.umiImportItems) == null ? void 0 : _d.includes(name)) {
          replaceWith(path, name, "umi", state.file, () => (0, import_helper_module_imports.addNamed)(path, name, "umi"));
        }
        if (name === "React") {
          replaceWith(path, name, "react", state.file, () => (0, import_helper_module_imports.addDefault)(path, "react", { nameHint: name }));
        }
        if ((_e = state.opts.reactImportItems) == null ? void 0 : _e.includes(name)) {
          replaceWith(path, name, "react", state.file, () => (0, import_helper_module_imports.addNamed)(path, name, "react"));
        }
      },
      MemberExpression(path, state) {
        ...
        if (((_a = state.opts.opts.withObjs) == null ? void 0 : _a[object.name]) && (((_b = state.opts.opts.withObjs) == null ? void 0 : _b[object.name].members) || []).includes(property.name)) {
          const libName = state.opts.opts.withObjs[object.name].importFrom;
          replaceWith(path, property.name, libName, state.file, () => (0, import_helper_module_imports.addNamed)(path, property.name, libName));
        }
      }
    }
  };
