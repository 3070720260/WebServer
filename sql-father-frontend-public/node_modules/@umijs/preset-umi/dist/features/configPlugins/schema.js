...
function getSchemas() {
  return {
    ...
    npmClient: (Joi) => Joi.string().valid(import_utils.NpmClientEnum.pnpm, import_utils.NpmClientEnum.tnpm, import_utils.NpmClientEnum.cnpm, import_utils.NpmClientEnum.yarn, import_utils.NpmClientEnum.npm),
