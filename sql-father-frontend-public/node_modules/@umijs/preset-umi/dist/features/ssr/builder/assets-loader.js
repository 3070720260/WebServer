  ...
  return {
    ...
    setup(build) {
      ...
      build.onLoad({ filter: assetsFilter, namespace: NAMESPACE }, async (args) => {
        const filename = (0, import_utils.winPath)(args.path).replace((0, import_css_loader.ensureLastSlash)((0, import_utils.winPath)(opts.cwd)), "");
