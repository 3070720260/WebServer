...
`,
    fn: async function() {
      ...
      (0, import_assert.default)((0, import_fs.existsSync)(distDir), "build output dir not found, please run umi build");
      ...
      if (proxy) {
        Object.keys(proxy).forEach((key) => {
          ...
          if (target) {
            app.use(key, (0, import_http_proxy_middleware.createProxyMiddleware)(key, __spreadProps(__spreadValues({}, proxy[key]), {
              onProxyRes(proxyRes, req, res) {
                var _a, _b;
                proxyRes.headers["x-real-url"] = ((_a = new URL(req.url || "", target)) == null ? void 0 : _a.href) || "";
                (_b = proxyConfig.onProxyRes) == null ? void 0 : _b.call(proxyConfig, proxyRes, req, res);
              }
            })));
          }
        });
      }
      app.use((0, import_createMockMiddleware.createMockMiddleware)({
        context: {
      ...
      app.use(api.config.base, (0, import_sirv.default)(distDir, {
        etag: true,
        dev: true,
        single: true
      }));
