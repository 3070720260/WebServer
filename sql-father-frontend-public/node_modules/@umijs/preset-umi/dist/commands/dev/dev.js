...
`,
    async fn() {
      ...
      (0, import_watch.addUnWatch)(api.service.configManager.watch({
      ...
      const opts = __spreadProps(__spreadValues({
        ...
        onMFSUProgress(opts2) {
          api.appData.mfsuBundleStatus = __spreadValues(__spreadValues({}, api.appData.mfsuBundleStatus), opts2);
        },
