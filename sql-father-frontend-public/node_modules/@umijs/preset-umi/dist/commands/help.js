...
${getDeps(commands)}
`);
    console.log(`Run \`${import_utils.chalk.bold("umi help <command>")}\` for more information of specific commands.`);
    console.log(`Visit ${import_utils.chalk.bold("https://umijs.org/")} to learn more about Umi.`);
    console.log();
  }
