...
var InlineErrorFormItemPopover = function InlineErrorFormItemPopover(_ref) {
  ...
  return _jsx(Popover, _objectSpread(_objectSpread(_objectSpread({
  ...
  return _jsx(Form.Item, _objectSpread(_objectSpread({
    ...
    _internalItemRender: {
      ...
      render: function render(inputProps, doms) {
        return _jsx(InlineErrorFormItemPopover, _objectSpread({
...
export var InlineErrorFormItem = function InlineErrorFormItem(props) {
  ...
  if (name && (rules === null || rules === void 0 ? void 0 : rules.length) && errorType === 'popover') {
    return _jsx(InternalFormItemFunction, _objectSpread(_objectSpread({
      name: name,
      rules: rules,
      popoverProps: popoverProps
    }, rest), {}, {
