...
import { ObjToMap, proFieldParsingText, useFieldFetchData } from '../Select'; // 兼容代码-----------
...
var FieldCheckbox = function FieldCheckbox(_ref, ref) {
  ...
  var _useFieldFetchData = useFieldFetchData(rest),
      ...
      _fetchData = _useFieldFetchData2[2]; // css


  var _useStyle = useStyle('Checkbox', function (token) {
    return _defineProperty({}, ".".concat(layoutClassName), {
      '&-vertical': _defineProperty({}, "".concat(token.antCls, "-checkbox-group-item"), {
        display: 'flex',
        marginInlineEnd: 0
      })
    });
