...
import React, { useContext, useState } from 'react'; // 兼容代码-----------
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    if (light) {
      ...
      _dom = _jsxs("div", {
        ...
        children: [_jsx(TimePicker, _objectSpread(_objectSpread({
          value: dayValue,
          format: format,
          ref: ref
        }, fieldProps), {}, {
      ...
      _dom = _jsx(DatePicker.TimePicker, _objectSpread(_objectSpread({
        ref: ref,
        format: format,
...
var FieldTimeRangePickerComponents = function FieldTimeRangePickerComponents(_ref2, ref) {
  ...
  if (mode === 'edit' || mode === 'update') {
    ...
    var _dom2 = _jsx(TimePicker.RangePicker, _objectSpread(_objectSpread({
      ref: ref,
      format: format,
      bordered: plain === undefined ? true : !plain
    }, fieldProps), {}, {
