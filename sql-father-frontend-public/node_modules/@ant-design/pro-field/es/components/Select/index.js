...
import { useSafeState, nanoid, useDebounceValue, useDeepCompareEffect, useMountMergeState, useStyle } from '@ant-design/pro-utils';
...
import SearchSelect from './SearchSelect'; // 兼容代码-----------
...
var Highlight = function Highlight(_ref) {
  ...
  var optionCls = getPrefixCls('pro-select-item-option-content'); // css
  ...
  if (mode === 'edit' || mode === 'update') {
    var renderDom = function renderDom() {
      ...
      return _jsx(SearchSelect, _objectSpread(_objectSpread({
        ...
        ref: inputRef,
        allowClear: true,
        notFoundContent: loading ? _jsx(Spin, {
          size: "small"
