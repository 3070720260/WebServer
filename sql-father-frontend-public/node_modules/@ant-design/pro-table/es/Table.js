...
import { jsx as _jsx, Fragment as _Fragment, jsxs as _jsxs } from "react/jsx-runtime"; // 兼容代码-----------
...
function TableRender(props) {
  ...
  var baseTableDom = _jsx(Table, _objectSpread(_objectSpread({}, getTableProps()), {}, {
    rowKey: rowKey
  }));
  /** 自定义的 render */
...
var ProviderWarp = function ProviderWarp(props) {
  ...
  var _useStyle = useStyle(getPrefixCls('pro-table')),
  ...
  return _jsx(Container.Provider, {
    ...
    children: _jsx(ConfigProviderWrap, {
      children: _jsx(ErrorComponent, {
        children: wrapSSR(_jsx(ProTable, _objectSpread({
