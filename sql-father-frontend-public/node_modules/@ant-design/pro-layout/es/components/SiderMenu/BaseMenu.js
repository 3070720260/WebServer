...
var MenuUtil = /*#__PURE__*/_createClass(function MenuUtil(props) {
  ...
  this.getSubMenuOrItem = function (item, level) {
    ...
    warningOnce(!(item === null || item === void 0 ? void 0 : item.routes), 'routes 将会废弃，为了保证兼容请使用 children 作为子节点定义方式');
    ...
    if (Array.isArray(children) && children.length > 0) {
      ...
      var defaultTitle = _jsxs("div", {
        title: name,
        className: classNames("".concat(baseClassName, "-item-title"), (_this$props3 = _this.props) === null || _this$props3 === void 0 ? void 0 : _this$props3.hashId, (_classNames = {}, _defineProperty(_classNames, "".concat(baseClassName, "-item-title-collapsed"), collapsed), _defineProperty(_classNames, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames)),
        children: [menuType === 'group' && collapsed ? null : shouldHasIcon && iconDom ? _jsx("span", {
      ...
      return [{
        ...
        className: menuType == 'group' ? "".concat(baseClassName, "-group") : "".concat(baseClassName, "-submenu")
      }, isGroup && level === 0 ? {
        type: 'divider',
        prefixCls: prefixCls,
  ...
  this.getMenuItemPath = function (item, level) {
    ...
    var defaultItem = _jsxs("div", {
      className: classNames("".concat(baseClassName, "-item-title"), (_this$props10 = _this.props) === null || _this$props10 === void 0 ? void 0 : _this$props10.hashId, (_classNames3 = {}, _defineProperty(_classNames3, "".concat(baseClassName, "-item-title-collapsed"), collapsed), _defineProperty(_classNames3, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames3)),
    ...
    if (isHttpUrl) {
      ...
      defaultItem = _jsxs("span", {
        ...
        className: classNames("".concat(baseClassName, "-item-title"), (_this$props13 = _this.props) === null || _this$props13 === void 0 ? void 0 : _this$props13.hashId, (_classNames5 = {}, _defineProperty(_classNames5, "".concat(baseClassName, "-item-title-collapsed"), collapsed), _defineProperty(_classNames5, "".concat(baseClassName, "-item-link"), true), _defineProperty(_classNames5, "".concat(baseClassName, "-item-collapsed-show-title"), (menu === null || menu === void 0 ? void 0 : menu.collapsedShowTitle) && collapsed), _classNames5)),
        children: [icon ? _jsx("span", {
...
var BaseMenu = function BaseMenu(props) {
  ...
  var baseClassName = "".concat(prefixCls, "-base-menu"); // 用于减少 defaultOpenKeys 计算的组件
  ...
  return wrapSSR( /*#__PURE__*/_createElement(Menu, _objectSpread(_objectSpread({}, openKeysProps), {}, {
    ...
    className: classNames(className, hashId, baseClassName, (_classNames7 = {}, _defineProperty(_classNames7, "".concat(baseClassName, "-horizontal"), mode === 'horizontal'), _defineProperty(_classNames7, "".concat(baseClassName, "-collapsed"), props.collapsed), _classNames7)),
