...
import { Alert, Button, Divider, ConfigProvider as AntConfigProvider, Drawer, List, message, Switch, version } from 'antd';
...
var updateTheme = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(dark) {
  ...
  return function updateTheme(_x) {
...
export var SettingDrawer = function SettingDrawer(props) {
  ...
  var drawerOpenProps = compareVersions(version, '4.23.0') > -1 ? {
    open: open,
  ...
  return wrapSSR(_jsxs(_Fragment, {
    children: [_jsx("div", {
      ...
      children: open ? _jsx(CloseOutlined, {
        style: {
          color: '#fff',
          fontSize: 20
        }
    ...
    }), _jsx(Drawer, _objectSpread(_objectSpread({}, drawerOpenProps), {}, {
      width: 300,
      closable: false,
      placement: "right",
      ...
      children: _jsxs("div", {
        ...
        children: [_jsx(Body, {
          ...
          }), settingState.layout == 'side' || settingState.layout == 'mix' ? _jsx(Body, {
            hashId: hashId,
            prefixCls: baseClassName,
            title: formatMessage({
