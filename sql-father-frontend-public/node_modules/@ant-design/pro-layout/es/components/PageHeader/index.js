...
var PageHeader = function PageHeader(props) {
  ...
  var className = classNames(prefixCls, props.className, customizeClassName, (_classNames = {
    hashId: hashId
  }, _defineProperty(_classNames, "".concat(prefixCls, "-has-breadcrumb"), !!breadcrumbDom), _defineProperty(_classNames, "".concat(prefixCls, "-has-footer"), !!footer), _defineProperty(_classNames, "".concat(prefixCls, "-ghost"), ghost), _defineProperty(_classNames, "".concat(prefixCls, "-rtl"), direction === 'rtl'), _defineProperty(_classNames, "".concat(prefixCls, "-compact"), compact), _classNames));
